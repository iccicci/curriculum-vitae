...
const experiences: { title: string; company: string; from: Date; to?: Date; content: ReactElement; last?: boolean }[] = [
  ...
  {
    company: "Docomodigital Spa (formerly Buongiorno Spa, formerly DADA Spa)",
    content: (
      <>
  ...
  },
  {
    ...
    content: (
      <>
        Contributed to the development of <b>MEGAS</b>, the world&apos;s first ultrasound system capable of real-time image storage in{" "}
        <a href="https://www.esaote.com/fileadmin/user_upload/Download/FB_CnTI_160000122MAK_V01_LR.pdf">CnTI</a> format. Designed and developed the
        <b>firmware</b> for the <b>D.A.M. board</b>, written in <b>C++</b> under for <b>Linux</b>, fitting within <b>a single 1.4MB floppy disk</b>.
        Also specialized in optimizing procedures for <b>electrocardiographs</b>, enhancing performance and efficiency.
      </>
    ),
  ...
  },
  {
    ...
    content: (
      <>
        ...
        Additionally, collaborated on several major projects for DADA and its top clients, including <b>Supereva</b> (social network),
        <b>Incontri</b> (dating platform) and <b>La Nazione</b> (online newspaper).
      </>
    ),
